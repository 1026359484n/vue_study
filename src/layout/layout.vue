...
<script lang="ts">
import VabLogo from "./logo.vue";
import VabAvatar from "./avatar.vue";
import VabMenu from "./menu.vue";
import VabTabs from "./tabs.vue";
import VabContent from "./content.vue";
